...
#SBATCH --job-name=failed_download       # Job name
...
echo -e "name\npassword" | downloadcmd -dp 1235636 -u name -d output_path -wt 191 -t "failed_csv_file_path"
